...
这样子注意力权重$\overline{\alpha}$ 很容易解释了。当产生单词**vas**的时候（对应英语**are**），我们期望$\overline{\alpha_{are}}$ 接近1，而$\overline{\alpha_{how}}$和$\overline{\alpha_{you}}$接近0。直觉上注意力向量$c$大致接近**are**的隐含层向量，它有助于产生法语单词**vas**。
