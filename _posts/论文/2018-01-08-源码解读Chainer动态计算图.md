...
可以说Chainer的引入的动态图机制是革命性的，不得不佩服日本人开发的这款框架，简介好用，代码基于python，易于阅读，实在是居家旅行不可不少的休闲阅读佳作，这对于连**计算图**是个啥球的我来说，简直太棒了！不多说了，我们拿出[论文](http://learningsys.org/papers/LearningSys_2015_paper_33.pdf)，结合[代码](https://github.com/chainer/chainer)，一睹为快。
...
<img src="http://p28sk9doh.bkt.clouddn.com/b.png" width="300" style="float:center">
